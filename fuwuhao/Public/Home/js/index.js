...
$(document).ready(function(){
  $(".ipt_item .check_sp").click(function(){
	...
	$(".btn").click(function(){
		...
		$("body").append('<div class="loading_mask"></div><div class="loading_cont">请稍后，系统正在处理您的信息！</div>');
		$.ajax({
		   type: "POST",
		   url: $("#u_form").attr('action'),
		   data:$("#u_form").serialize(),
		   success: function(msg){
             $(".loading_mask,.loading_cont").detach();
			 if(msg.status==1)
			   $(this).msg({msg:'注册成功！马上去看看您简评信息吧。',url:msg.url});
			 else
